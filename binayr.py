...
# of 2 smaller than the number and put a 1 i that column. You then take the
...
# challenge.
#
# The program should create for numbers up to 65535; i.e. (2 ** 16) - 1
#
# Hint: you will need integer division(//), and modulo (%) to get remainder.
