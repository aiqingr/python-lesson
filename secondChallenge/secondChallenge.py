...
# abd prints out the number of segments it contains, and the length of each segment
#
...
# 	255
#
# So your program should work even with invalid IP address. We're just interested in the
...
ipAddress = input("Please enter an Ip address. An IP address consist of 4 numbers, "
